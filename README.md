...
session memory inside Tessera Studio.
...
Install dependencies and start Studio with Bun 1.4 or newer:
...
`bun run dev:studio` starts Studio on `http://127.0.0.1:4317`.
