...
import type { RankingArtifact as RankingArtifactData, TargetArtifact as TargetArtifactData, TimelineArtifact as TimelineArtifactData } from "@data-elements/schema";
