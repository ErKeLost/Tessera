...
type ArtifactAgentLogoProps = SVGProps<SVGSVGElement> & {
  title?: string;
};

export function ArtifactAgentLogo({ title, ...props }: ArtifactAgentLogoProps) {
  const id = useId();
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${clipId})`}>
        <rect
          fill="var(--artifact-logo-surface, #1f2123)"
          height="42.1667"
          rx="8.58333"
          width="42.1667"
          x="1.91667"
        ...
        <path
          ...
          fill="var(--artifact-logo-glyph, #fff)"
          fillRule="evenodd"
          opacity="0.5"
        />
        <path
      ...
      <rect
        height="44.1375"
        rx="9.56875"
        stroke="var(--artifact-logo-outline, rgb(0 0 0 / 0.6))"
        strokeWidth="0.1375"
        width="44.1375"
        x="0.93125"
        y="0.289648"
      ...
      <defs>
        <linearGradient
          ...
          y2="44.3584"
        >
          <stop stopColor="var(--artifact-logo-border-start, #2e3032)" />
          <stop offset="1" stopColor="var(--artifact-logo-border-end, #101214)" />
        </linearGradient>
        <clipPath id={clipId}>
