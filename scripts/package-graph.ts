...
export const packageGraph: readonly PackageDefinition[] = [
  ...
  { directory: "packages/tessera-react", name: "@open-tessera/react", dependencies: ["@open-tessera/core", "@open-tessera/runtime", "@open-tessera/schema"] },
  ...
  { directory: "apps/studio", name: "@open-tessera/studio", dependencies: ["@open-tessera/capabilities", "@open-tessera/compiler", "@open-tessera/data-agent", "@open-tessera/database", "@open-tessera/mongodb", "@open-tessera/mysql", "@open-tessera/postgres", "@open-tessera/react", "@open-tessera/runtime", "@open-tessera/schema", "@open-tessera/sqlite", "@open-tessera/turso"] },
];
