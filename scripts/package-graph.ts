...
export const packageGraph: readonly PackageDefinition[] = [
  ...
  { directory: "packages/ui", name: "@open-generative/ui", dependencies: ["@open-generative/protocol", "@open-generative/catalog", "@open-generative/react", "@open-generative/components"] },
